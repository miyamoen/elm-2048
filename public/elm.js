...
var author$project$Main$PutMany = function (a) {
	return {$: 'PutMany', a: a};
};
var author$project$Main$Cell = F3(
	function (position, num, id) {
		return {id: id, num: num, position: position};
	});
var author$project$Main$getCell = function (animationCell) {
	switch (animationCell.$) {
		case 'ShowUpCell':
			var cell = animationCell.a;
			return cell;
		case 'MoveCell':
			var cell = animationCell.a;
			return cell;
...
var author$project$Main$emptyPositionList = F2(
	function (_n0, board) {
		var width = _n0.a;
		var height = _n0.b;
...
var author$project$Main$randomEmptyPositions = F3(
	function (length, size, board) {
		return A2(
			elm$random$Random$map,
			elm$core$List$take(length),
			elm_community$random_extra$Random$List$shuffle(
				A2(author$project$Main$emptyPositionList, size, board)));
	});
...
var author$project$Main$randomNum = A2(
...
var author$project$Main$randomCells = F3(
	function (n, size, board) {
		var positionList = A3(author$project$Main$randomEmptyPositions, n, size, board);
		var numList = A2(elm$random$Random$list, n, author$project$Main$randomNum);
		return A3(
			elm$random$Random$map2,
			elm$core$List$map2(author$project$Main$Cell),
			positionList,
			numList);
	});
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		...
		A2(
			elm$random$Random$generate,
			author$project$Main$PutMany,
			A3(
				author$project$Main$randomCells,
				2,
				_Utils_Tuple2(4, 4),
				_List_Nil)));
};
...
var author$project$Main$directionDecoder = function (string) {
	switch (string) {
		case 'ArrowLeft':
		...
		default:
			return elm$json$Json$Decode$fail('NoControlKey');
	}
};
...
var author$project$Main$keyDecoder = A2(
	...
	author$project$Main$directionDecoder,
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2(elm$json$Json$Decode$map, author$project$Main$Slide, author$project$Main$keyDecoder))
			]));
};
var author$project$Main$Over = {$: 'Over'};
var author$project$Main$Put = function (a) {
	return {$: 'Put', a: a};
};
var author$project$Main$ShowUpCell = function (a) {
	return {$: 'ShowUpCell', a: a};
};
var author$project$Main$Won = {$: 'Won'};
var author$project$Main$toDict = function (board) {
		...
		A2(
			...
			A2(
				...
				function (_n0) {
					...
					return _Utils_Tuple2(position, num);
				}),
			board));
};
var author$project$Main$boardEqual = F2(
	function (a, b) {
		return _Utils_eq(
			elm$core$List$length(a),
			elm$core$List$length(b)) && _Utils_eq(
			author$project$Main$toDict(a),
			author$project$Main$toDict(b));
	});
var author$project$Main$scoreHelp = function (animationCell) {
	if (animationCell.$ === 'MergeCell') {
		var num = animationCell.a.num;
		return num;
	} else {
		return 0;
	}
};
var author$project$Main$countScore = function (board) {
	return elm$core$List$sum(
		A2(elm$core$List$map, author$project$Main$scoreHelp, board));
};
...
var author$project$Main$randomPosition = function (_n0) {
	var width = _n0.a;
	var height = _n0.b;
	return A2(
		elm$random$Random$pair,
		A2(elm$random$Random$int, 0, width - 1),
		A2(elm$random$Random$int, 0, height - 1));
};
...
var elm_community$random_extra$Random$Set$notInSet = F2(
	function (aSet, generator) {
		return A2(
			elm_community$random_extra$Random$Extra$filter,
			function (element) {
				return !A2(elm$core$Set$member, element, aSet);
			},
			generator);
	});
var author$project$Main$randomEmptyPosition = F2(
	function (size, board) {
		return A2(
			elm_community$random_extra$Random$Set$notInSet,
			elm$core$Set$fromList(
				A2(
					elm$core$List$map,
					A2(
					...
					board)),
			author$project$Main$randomPosition(size));
	});
var author$project$Main$randomCell = F2(
	function (size, board) {
		return A3(
			elm$random$Random$map2,
			author$project$Main$Cell,
			A2(author$project$Main$randomEmptyPosition, size, board),
			author$project$Main$randomNum);
	});
var author$project$Main$MergeCell = F2(
	function (a, b) {
		return {$: 'MergeCell', a: a, b: b};
	});
var author$project$Main$MoveCell = F2(
	function (a, b) {
		return {$: 'MoveCell', a: a, b: b};
	});
var author$project$Main$accumulate = F2(
	function (cell, cells) {
		if (cells.b) {
			switch (cells.a.$) {
				case 'MergeCell':
					...
					return A2(
						elm$core$List$cons,
						A2(author$project$Main$MoveCell, cell, cell.position),
						cells);
				case 'MoveCell':
					var _n2 = cells.a;
					var nearest = _n2.a;
					var rest = cells.b;
					return _Utils_eq(nearest.num, cell.num) ? A2(
						elm$core$List$cons,
						A2(
							...
							_Utils_update(
								cell,
								{num: cell.num * 2}),
							_Utils_Tuple2(cell.position, nearest.position)),
						rest) : A2(
						elm$core$List$cons,
						A2(author$project$Main$MoveCell, cell, cell.position),
						cells);
	...
	function (index, board) {
		return A2(
			...
			A2(
				...
				A2(elm$core$List$map, author$project$Main$getCell, board)));
	});
...
var author$project$Main$replacePosition = F2(
	function (position, animationCell) {
		switch (animationCell.$) {
			case 'ShowUpCell':
				var cell = animationCell.a;
				return author$project$Main$ShowUpCell(
					_Utils_update(
						cell,
						{position: position}));
			case 'MoveCell':
				var cell = animationCell.a;
				var old = animationCell.b;
				return A2(
					author$project$Main$MoveCell,
					_Utils_update(
						cell,
						{position: position}),
					old);
...
var author$project$Main$slideBoard = F3(
	function (_n0, direction, board) {
		var width = _n0.a;
		var height = _n0.b;
		switch (direction.$) {
			case 'Left':
					...
					function (j) {
						return A2(
							...
							F2(
								function (i, cell) {
									return A2(
										author$project$Main$replacePosition,
										_Utils_Tuple2(i, j),
										cell);
								}),
							elm$core$List$reverse(
								A3(
									elm$core$List$foldl,
									author$project$Main$accumulate,
									_List_Nil,
									A2(author$project$Main$getRow, j, board))));
					},
					A2(elm$core$List$range, 0, height - 1));
			case 'Right':
				return A2(
						...
						return A2(
							...
							elm$core$List$reverse(
								A3(
									...
									author$project$Main$accumulate,
									_List_Nil,
									A2(author$project$Main$getColumn, i, board))));
					},
					A2(elm$core$List$range, 0, width - 1));
			default:
				return A2(
...
var author$project$Main$stuck = F2(
	function (size, board) {
		var w = size.a;
		var h = size.b;
		return _Utils_eq(
			...
			function (direction) {
				return A2(
					author$project$Main$boardEqual,
					board,
					A3(author$project$Main$slideBoard, size, direction, board));
			},
			_List_fromArray(
				[author$project$Main$Left, author$project$Main$Right, author$project$Main$Up, author$project$Main$Down]));
	});
var author$project$Main$won = function (board) {
	return A2(
		elm$core$List$any,
		A2(
			elm$core$Basics$composeR,
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Slide':
				var direction = msg.a;
				var slidedBoard = A3(author$project$Main$slideBoard, model.size, direction, model.board);
				var _n1 = A2(author$project$Main$boardEqual, model.board, slidedBoard) ? _Utils_Tuple2(0, elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					author$project$Main$countScore(model.board),
					A2(
						elm$random$Random$generate,
						author$project$Main$Put,
						A2(author$project$Main$randomCell, model.size, slidedBoard)));
				var increase = _n1.a;
				var cmd = _n1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{board: slidedBoard, score: model.score + increase}),
					cmd);
			case 'Put':
				var toCell = msg.a;
				var newBoard = A2(
					elm$core$List$cons,
					author$project$Main$ShowUpCell(
						toCell(
							elm$core$String$fromInt(model.nextId))),
					model.board);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							state: A2(author$project$Main$stuck, model.size, newBoard) ? author$project$Main$Over : (author$project$Main$won(newBoard) ? author$project$Main$Won : author$project$Main$Playing)
						}),
								...
								A2(
									...
									F2(
										function (i, toCell) {
											return author$project$Main$ShowUpCell(
												toCell(
													elm$core$String$fromInt(model.nextId + i)));
										}),
									toCells),
								model.board),
							nextId: model.nextId + elm$core$List$length(toCells)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$class = A2(elm$core$Basics$composeL, mdgriffith$elm_ui$Element$htmlAttribute, elm$html$Html$Attributes$class);
			...
			_List_fromArray(
				[
					...
					function () {
						switch (num) {
							case 2:
								return A3(mdgriffith$elm_ui$Element$rgb255, 238, 238, 238);
							case 4:
								return A3(mdgriffith$elm_ui$Element$rgb255, 248, 252, 223);
							case 8:
								return A3(mdgriffith$elm_ui$Element$rgb255, 243, 190, 152);
							case 16:
								return A3(mdgriffith$elm_ui$Element$rgb255, 234, 162, 109);
							case 32:
								return A3(mdgriffith$elm_ui$Element$rgb255, 245, 156, 135);
							case 64:
								return A3(mdgriffith$elm_ui$Element$rgb255, 255, 97, 61);
							case 128:
								return A3(mdgriffith$elm_ui$Element$rgb255, 238, 229, 161);
							case 256:
								return A3(mdgriffith$elm_ui$Element$rgb255, 245, 231, 132);
							case 512:
								return A3(mdgriffith$elm_ui$Element$rgb255, 228, 214, 111);
							case 1024:
								return A3(mdgriffith$elm_ui$Element$rgb255, 224, 195, 88);
							case 2048:
								return A3(mdgriffith$elm_ui$Element$rgb255, 196, 224, 88);
							default:
								return A3(mdgriffith$elm_ui$Element$rgb255, 100, 100, 100);
						}
					}()),
					mdgriffith$elm_ui$Element$Font$color(
					((num === 2) || (num === 4)) ? A3(mdgriffith$elm_ui$Element$rgb255, 34, 34, 34) : A3(mdgriffith$elm_ui$Element$rgb255, 250, 250, 250))
				]),
			_List_fromArray(
				[
					A2(
...
var author$project$Main$positionHelp = F5(
	function (cls1, cls2, cls3, _n0, num) {
		var i = _n0.a;
		var j = _n0.b;
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$moveRight(((i * 50) + (i * 5)) + 10),
								mdgriffith$elm_ui$Element$moveDown(((j * 50) + (j * 5)) + 10),
								author$project$Main$class(cls2)
							]),
						_Utils_Tuple2(
							'ss',
							A3(mdgriffith$elm_ui$Element$Lazy$lazy2, author$project$Main$viewCell, cls3, num)))),
					author$project$Main$class(cls1)
				]),
			_Utils_Tuple2('nn', mdgriffith$elm_ui$Element$none));
	});
...
var author$project$Main$viewAnimationCell = function (animationCell) {
	var cell = author$project$Main$getCell(animationCell);
	switch (animationCell.$) {
		case 'ShowUpCell':
			return A6(mdgriffith$elm_ui$Element$Lazy$lazy5, author$project$Main$positionHelp, '', '', 'showup', cell.position, cell.num);
		case 'MoveCell':
			var position = animationCell.b;
			return A6(mdgriffith$elm_ui$Element$Lazy$lazy5, author$project$Main$positionHelp, '', 'move', '', cell.position, cell.num);
		default:
			var _n1 = animationCell.b;
			var position = _n1.a;
			var position2 = _n1.b;
			return A6(mdgriffith$elm_ui$Element$Lazy$lazy5, author$project$Main$positionHelp, '', 'merge', '', cell.position, cell.num);
	}
};
...
var author$project$Main$viewAnimationCells = function (animationCells) {
	return A2(
		...
		A2(
			...
			function (cell) {
				return _Utils_Tuple2(
					author$project$Main$getCell(cell).id,
					author$project$Main$viewAnimationCell(cell));
			},
			animationCells));
};
...
var author$project$Main$viewEmptyCells = function (_n0) {
	var w = _n0.a;
	var h = _n0.b;
	return A2(
...
var author$project$Main$viewBoard = function (_n0) {
	var size = _n0.size;
	var board = _n0.board;
	var _n1 = size;
	var w = _n1.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$width(
				mdgriffith$elm_ui$Element$px(((w * 50) + ((w - 1) * 5)) + 20)),
				mdgriffith$elm_ui$Element$height(
				mdgriffith$elm_ui$Element$px(((h * 50) + ((h - 1) * 5)) + 20)),
				mdgriffith$elm_ui$Element$padding(10),
				mdgriffith$elm_ui$Element$spacing(5),
				mdgriffith$elm_ui$Element$inFront(
				author$project$Main$viewAnimationCells(board))
			]),
		author$project$Main$viewEmptyCells(size));
};
var author$project$Main$viewResult = function (state) {
	switch (state.$) {
		case 'Won':
			return mdgriffith$elm_ui$Element$text('You win!');
		case 'Over':
			return mdgriffith$elm_ui$Element$text('Game over!');
		default:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					author$project$Main$viewResult(model.state)
				])));
};
